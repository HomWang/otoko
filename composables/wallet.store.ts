      ...
      this.onboard = await getOnboard([
        {
          ...
          rpcUrl: `https://mainnet.infura.io/v3/eb4d55e51c4345109278a16ac7e9811d`
        },
        // {
        //   id: '0x3',
        //   token: 'tROP',
...
export const getOnboard = async (chains: Chain[]): Promise<OnboardAPI> => {
  ...
  const walletConnectModule = (await import('@web3-onboard/walletconnect'))
    .default;
  // const coinbaseWalletModule = (await import('@web3-onboard/coinbase'))
  //   .default;
  ...
  const onboard = Onboard({
    ...
    // </svg>`, // svg string icon
      icon: 'https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg', // svg string logo
      logo: 'https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg', // svg string logo
      description: 'otoko',
